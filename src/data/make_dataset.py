...
loads the data and returns a list of the form [document, label],
...
load_dataframe():
Load the dataset in the form of a a dataframe:
...
def load_dataframe(filename=" ", header=None, id=None):
